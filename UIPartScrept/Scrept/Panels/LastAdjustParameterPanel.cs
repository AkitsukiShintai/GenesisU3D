...
public class LastAdjustParameterPanel : BasePanel,IDragHandler,IBeginDragHandler,IEndDragHandler
{
   ...
   // private float AllHeightOfChildren = 0;
    ...
    {     
        ...
        for (int i = 0; i < aboutShoe.ParameterList.Count; i++)
        {
            ...
            if (aboutShoe.ParameterList[i].ShowInterfacePart == ParameterBase.ShowInterfacePositon.OverallAdjustment && aboutShoe.ParameterList[i].IsShowInEdit)
            {
    ...
    private void RushDetail()
    {
        ...
        for (int i = 0; i < aboutShoe.ParameterList.Count; i++)
        {
            ...
            if (aboutShoe.ParameterList[i].ShowPosX != -1)
                continue;
            if (aboutShoe.ParameterList[i].ShowInterfacePart == ParameterBase.ShowInterfacePositon.DetailAdjustment&&aboutShoe.ParameterList[i].IsShowInEdit)
            {
